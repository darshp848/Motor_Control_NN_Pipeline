"""AEDT wrapper for one frozen direct-r6 quarter-sector qualification anchor.
...
bound to the write-once r6 attempt-1 campaign directory.
"""

import os

os.environ["EESM_REQUAL_MODE"] = "r6"
os.environ["EESM_R6_CAMPAIGN_ROOT"] = os.path.join(
    os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))),
    "out", "eesm", "task9_requalification_r6_attempt1_20260716",
)
